...
| CAL-001  | projeção sem persistência paralela    | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-002  | filtro por mês                        | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-003  | escopo Bruna/Matheus/Casal            | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-004  | parcela em nextDue                    | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-005  | fatura cruzando competência           | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-006  | ciclo vazio não é dívida              | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-007  | agenda reconcilia com grid            | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-008  | estado vazio                          | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-009  | pagamento muda status sem duplicidade | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-010  | ações reutilizam domínio de parcela   | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-011  | histórico não vira compromisso        | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-012  | fechamento é marco                    | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-013  | previsão usa dados conhecidos         | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-014  | compra + vencimento não duplicam      | -                                | -                                        | -                                                     | -                     | MISSING |
| CAL-015  | virada de ano preserva projeção       | -                                | -                                        | -                                                     | -                     | MISSING |
