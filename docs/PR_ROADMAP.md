...
| #55 | `feature/calendar-commitments-pr55`         | Calendário & Compromissos. **Em implementação.** Projeta transações e compromissos existentes; não cria uma fonte de verdade paralela.                                                                                                                                                                                                             |
